  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500 to-blue-500 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
        <div className="mb-6">
          <div className="w-24 h-24 mx-auto bg-gradient-to-br from-purple-400 to-blue-400 rounded-full flex items-center justify-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">MBIT 性格测试</h1>
          <p className="text-gray-600">探索你的性格类型，了解真实的自己</p>
        </div>
        ...
        <div className="space-y-4 mb-8">
          <div className="bg-gray-50 p-4 rounded-lg text-left">
            ...
            <ul className="text-sm text-gray-600 space-y-3">
              <li className="flex items-start">
                ...
                共48道题目，每道题选择最符合你个性的选项
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-500 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                测试结果将根据你的选择生成个性化的性格分析
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-500 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-purple-50 p-4 rounded-lg flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600 text-center">了解你的性格特质</p>
            </div>
            <div className="bg-blue-50 p-4 rounded-lg flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600 text-center">获取专业分析报告</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600 text-center">发现适合的职业方向</p>
            </div>
            <div className="bg-yellow-50 p-4 rounded-lg flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600 text-center">探索个人成长路径</p>
            </div>
          </div>
        </div>

        <button
          className="w-full py-4 px-6 bg-gradient-to-r from-purple-500 to-blue-500 text-white font-medium rounded-lg hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 text-lg flex items-center justify-center"
          onClick={onStartTest}
        >
